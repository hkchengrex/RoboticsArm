...
#define ENCODER_3_A_PIN_SRC GPIO_PinSource6
#define ENCODER_3_A_LINE EXTI_Line6

#define ENCODER_3_B_PORT GPIOB
#define ENCODER_3_B_PIN GPIO_Pin_7
#define ENCODER_3_B_PORT_SRC GPIO_PortSourceGPIOB
#define ENCODER_3_B_PIN_SRC GPIO_PinSource7
#define ENCODER_3_B_LINE EXTI_Line7
